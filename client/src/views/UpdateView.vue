...
export default {
    data() {
        return {
            ...
            apellido: '',
            correo: '',
            urlConsulta: 'http://localhost/Vuety/Solutions/Php/Crud/server/api/leer_uno.php',
            urlGuardar: 'http://localhost/Vuety/Solutions/Php/Crud/server/api/actualizar.php'
        }
    },
    mounted() {
        ...
        this.urlConsulta = this.urlConsulta + '/?id=' + this.id
        this.getEmpleado()
    },
    methods: {
        getEmpleado() {
            axios.get(this.urlConsulta).then(
                response => (
        ...
        guardar() {
            ...
            if (this.nombre.trim() === '') {
                ...
                let parametros = {id:this.id,nombre: this.nombre.trim(),apellido: this.apellido.trim(),correo: this.correo.trim()}
                enviarSolicitud('POST', parametros, this.urlGuardar, 'Empleado Actualizado')
